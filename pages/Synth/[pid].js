...
export default function Synth(props) {
    ...
    const [effects, setEffects] = useState([{name: 'reverb', status: false, values: []}, {name: 'filter', status: false, values: []}, {name: 'compressor', status: false, values: []}, {name: 'phaser', status: false, values: []}, {name: 'chorus', status: false, values: []}, {name: 'vibrato', status: false, values: []}])
